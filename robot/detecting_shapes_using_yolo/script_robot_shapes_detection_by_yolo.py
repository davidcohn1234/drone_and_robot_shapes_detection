...
# model = torch.hub.load('ultralytics/yolov5', 'custom', path='./weights_simon_floor_from_unity_100_epoches_3_hour_40_minutes.pt')
# model = torch.hub.load('ultralytics/yolov5', 'custom', path='./weights_simon_floor.pt')
#model = torch.hub.load('ultralytics/yolov5', 'custom', path='./weights_simon_grayscale_236_epoches.pt')
model = torch.hub.load('ultralytics/yolov5', 'custom', path='./weights_simon_grayscale.pt')
#model = torch.hub.load('.', 'custom', path='./weights_simon_grayscale.pt', source='local')
